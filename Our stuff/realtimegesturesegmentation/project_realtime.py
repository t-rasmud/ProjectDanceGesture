...
class AccelPlot:
    ...
    def classify_event(self, segment_result):
        ...
        if score_comp_to_nicole < score_comp_to_rashmi:
            ...
            self.alignedSignal = {
            'x_p': alignedSignal_nicole_x_p,
            'y_p': alignedSignal_nicole_y_p,
            'z_p': alignedSignal_nicole_z_p,
            'mag_p':alignedSignal_nicole_mag_p
        }
            ...
            'y_p': alignedSignal_rashmi_y_p,
            'z_p': alignedSignal_rashmi_z_p,
            'mag_p':alignedSignal_rashmi_mag_p
        }
        ...
        print(linesx)
        self.ax2.plot(currentSegment['x_p'], label="current gesture", alpha=0.8, color="b")
        self.ax2.plot(self.bestAggregateGesture['x_p'], label="aggregate gesture", alpha=0.8, color="o")
        print(linesx)
...
def main():
    ...
    for i in range(0, num_vals_xp):
        line2dx, = ax2.plot(flip_rashmi_agg_x_p, label=labels_subplotsx[i], alpha=alphassub[i])
